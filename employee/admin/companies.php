...
<body>
    ...
    ?>
                ...
                <td><p><a href="cedit.php?id=<?php echo $id ?>" class="edit"><i class="fa fa-pencil-square"></i>&nbsp;Edit</a>&nbsp;&nbsp;<a href="cdelete.php?id=<?php echo $id ?>" class="delete"><i class="fa fa-trash"></i>&nbsp;Delete</a></p></td>
            </tr>
    <?php } ?>
        </table>
    <br>
