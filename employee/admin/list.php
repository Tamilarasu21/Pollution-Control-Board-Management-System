...
<body>
   ...
   ?>   <tr>
            ...
            <td><?php echo $des; ?></td>
            <td><?php echo $lang; ?></td>
            <td><p><a href="edit.php?id=<?php echo $id ?>" class="edit"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="delete.php?id=<?php echo $id ?>" class="delete"><i class="fa fa-trash"></i></a></p></td>
        </tr>   
    <?php } ?>
    </table>
    <br>
