...
<a href="profile.php" style="color:skyblue;text-decoration:none">
    <li><br><i class="fa fa-user-circle fa-2x"></i><br><br><?php 
    ...
    <li><a href="list.php"><i class="fa fa-list"></i>&nbsp;List</a></li>
    <li><a href="attendance.php"><i class="fa fa-tasks"></i>&nbsp;Attendance</a></li>
